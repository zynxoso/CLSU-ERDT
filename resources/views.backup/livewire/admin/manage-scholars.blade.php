        ...
        <div class="rounded-lg overflow-hidden border border-gray-200 shadow-sm hover:shadow-md transition-all duration-300 animate-fade-in" style="animation-delay: 0.2s" wire:loading.class="opacity-50">
            ...
            @else
                <div class="text-center py-12 animate-fade-in">
                    <div class="w-16 h-16 mx-auto bg-blue-600 rounded-full flex items-center justify-center mb-4 border border-blue-100 shadow-sm">
                    ...
                    <x-button
                        href="{{ route('admin.scholars.create') }}"
                        variant="primary"
                        icon="fas fa-user-plus" style="color: white;"
                        animate="true"
                    >
                        Add New Scholar
                    </x-button>
