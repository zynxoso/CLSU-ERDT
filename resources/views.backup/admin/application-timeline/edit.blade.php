...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Edit Timeline Item</h1>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="{{ route('admin.application-timeline.update', $applicationTimeline) }}" method="POST">
                @csrf
                @method('PUT')
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('activity') is-invalid @enderror"
                                   id="activity" name="activity" value="{{ old('activity', $applicationTimeline->activity) }}" required>
                            @error('activity')
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('first_semester') is-invalid @enderror"
                                   id="first_semester" name="first_semester" value="{{ old('first_semester', $applicationTimeline->first_semester) }}" required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('second_semester') is-invalid @enderror"
                                   id="second_semester" name="second_semester" value="{{ old('second_semester', $applicationTimeline->second_semester) }}" required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('sort_order') is-invalid @enderror"
                                   id="sort_order" name="sort_order" value="{{ old('sort_order', $applicationTimeline->sort_order) }}" min="0" required>
                            @error('sort_order')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control @error('is_active') is-invalid @enderror" id="is_active" name="is_active">
                                <option value="1" {{ old('is_active', $applicationTimeline->is_active) == 1 ? 'selected' : '' }}>Active</option>
                                <option value="0" {{ old('is_active', $applicationTimeline->is_active) == 0 ? 'selected' : '' }}>Inactive</option>
                            </select>
                            @error('is_active')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                ...
                <div class="form-group">
                    <button type="submit" class="btn btn-primary">
                        <i class="fas fa-save"></i> Update Timeline Item
                    </button>
