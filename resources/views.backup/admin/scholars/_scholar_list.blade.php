                    ...
                    <tr class="hover:bg-green-50 transition-colors duration-150">
                        <td class="px-4 py-2 whitespace-nowrap">
                            <div class="flex items-center">
                                <div class="flex-shrink-0 h-8 w-8 rounded-full bg-red-50 flex items-center justify-center overflow-hidden shadow-sm border border-red-200">
                        ...
                        <td class="px-4 py-2 whitespace-nowrap">
                            <div class="flex justify-center">
                                <span class="inline-flex justify-center items-center w-[100px] px-3 py-1.5 text-xs font-semibold rounded-full
                                    ...
                                    @elseif($scholar->status == 'Completed' || $scholar->status == 'Graduated') bg-red-700 text-white
                                    @elseif($scholar->status == 'On Extension') bg-green-700 text-white
                                    @elseif($scholar->status == 'New') bg-red-800 text-white
                        ...
                        <td class="px-4 py-2 whitespace-nowrap">
                            ...
                            <div class="w-full bg-gray-200 rounded-full h-1.5 overflow-hidden">
                                <div class="bg-gradient-to-r from-red-600 to-green-600 h-1.5 rounded-full transition-all duration-300" style="width: {{ $progress }}%"></div>
                            </div>
                            <span class="text-xs text-gray-500">{{ $progress }}%</span>
                        </td>
                        <td class="px-2 py-2 whitespace-nowrap text-center">
                            <div class="flex justify-center items-center space-x-1">
                                <a href="{{ route('admin.scholars.show', $scholar->id) }}" class="text-red-600 hover:text-red-700 transition-all hover:scale-110 inline-flex items-center justify-center h-7 w-7 bg-red-50 hover:bg-red-100 rounded-full" title="View Scholar">
                                    <i class="fas fa-eye text-xs"></i>
                                </a>
                                <a href="{{ route('admin.scholars.edit', $scholar->id) }}" class="text-green-600 hover:text-green-700 transition-all hover:scale-110 inline-flex items-center justify-center h-7 w-7 bg-green-50 hover:bg-green-100 rounded-full" title="Edit Scholar">
...
@else
    <div class="text-center py-12 animate-fade-in">
        <div class="w-16 h-16 mx-auto bg-red-50 rounded-full flex items-center justify-center mb-4 border border-red-200 shadow-sm">
            <i class="fas fa-user-graduate text-2xl text-red-600"></i>
        </div>
