...
<div class="min-h-screen">
    <div class="container mx-auto">
        <div class="mb-6 pt-6">
            <h1 class="text-2xl font-bold mt-2" style="color: #1f2937;">Fund Request Details</h1>
        </div>

        <!-- Request Progress -->
        @if($fundRequest->status != 'Draft' && $fundRequest->status != 'Rejected')
        <div class="rounded-xl overflow-hidden border shadow-lg mb-6 p-6" style="background-color: #e0e5ec; border-color: #d1d5db;">
            <!-- Enhanced Progress Bar with Icons -->
            <div class="pt-2">
                <div class="flex items-center text-sm mb-6" style="color: #6b7280;">
                    <span class="font-semibold" style="color: #1f2937;">Request Progress</span>
                </div>

                <div class="relative mt-8 mb-10 progress-container">
                    <!-- Enhanced Progress Bar Background -->
                    <div class="h-2 rounded-full w-full shadow-inner" style="background-color: #d1d5db;"></div>
                    ...
                    @php
                        ...
                        $progressColor = $fundRequest->status == 'Approved' ? 'bg-emerald-500' : 'bg-amber-500';
                    @endphp

                    <div class="progress-bar h-2 rounded-full absolute top-0 left-0 transition-all duration-1500 ease-out shadow-md"
                         style="width: {{ $progressWidth }}; background-color: {{ $fundRequest->status == 'Approved' ? '#10b981' : '#f59e0b' }};">
                    ...
                    <div class="status-icons flex justify-between absolute w-full top-0 transform -translate-y-1/2 mt-5">
                        ...
                        <div class="status-icon-wrapper flex flex-col items-center transition-all duration-500" data-status="Under Review">
                            <div class="w-8 h-8 rounded-full border-2 flex items-center justify-center shadow-lg transform transition-all duration-500 hover:scale-110"
                                style="@if($fundRequest->status == 'Under Review')
                ...
                <div class="rounded-lg p-4 mt-6" style="background-color: rgba(255,255,255,0.5);">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center space-x-3">
                            <div class="w-3 h-3 rounded-full" style="background-color: {{ $fundRequest->status == 'Approved' ? '#10b981' : '#f59e0b' }};"></div>
                            <div class="text-sm" style="color: #6b7280;">
                                <span>Current Status: </span>
                                <span class="font-bold text-lg px-3 py-1 rounded-full"
                                    style="{{ $fundRequest->status == 'Approved' ? 'color: #10b981; background-color: #d1fae5;' :
                                      ($fundRequest->status == 'Under Review' ? 'color: #f59e0b; background-color: #fef3c7;' :
                                      ($fundRequest->status == 'Submitted' ? 'color: #10b981; background-color: #d1fae5;' : 'color: #6b7280;')) }}">
                                    {{ $fundRequest->status }}
                                </span>
                            </div>
                        </div>
                        <div class="text-sm" style="color: #6b7280;">
                            <i class="fas fa-clock mr-1" style="color: #10b981;"></i>
        ...
        <div x-data="{
        ...
        }" class="rounded-xl shadow-2xl border mb-8 overflow-hidden" style="background-color: #e0e5ec; border-color: #d1d5db;">

            <!-- Section Header -->
            <div class="border-b" style="background: linear-gradient(to right, #10b981, #007527); border-color: #d1d5db;">
                <div class="px-6 py-5">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center space-x-4">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-green-100 mt-1">Complete details of your funding request</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center space-x-3">
                            <button
                                ...
                                class="inline-flex items-center px-4 py-2 rounded-lg text-sm font-medium text-white transition-all duration-200 shadow-sm hover:shadow-md"
                                style="background-color: #10b981; border: 1px solid #059669;"
                                onmouseover="this.style.backgroundColor='#059669'; this.style.borderColor='#047857';"
                                onmouseout="this.style.backgroundColor='#10b981'; this.style.borderColor='#059669';"
                                :style="!showDetails ? 'background-color: #059669; border-color: #047857;' : ''"
                            >
                            ...
                            <button
                                ...
                                class="inline-flex items-center px-4 py-2 text-white rounded-lg text-sm font-medium transition-all duration-200 shadow-sm hover:shadow-md"
            ...
            <div x-show="showDetails"
                 ...
                 class="p-6" style="background-color: rgba(255,255,255,0.5);">

                <!-- Status Badge -->
                <div class="mb-6">
                    <div class="inline-flex items-center px-4 py-2 rounded-full text-sm font-semibold"
                        style="{{ $fundRequest->status == 'Approved' ? 'background-color: #d1fae5; color: #065f46; border: 1px solid #a7f3d0;' :
                          ($fundRequest->status == 'Under Review' ? 'background-color: #fef3c7; color: #92400e; border: 1px solid #fde68a;' :
                          ($fundRequest->status == 'Submitted' ? 'background-color: #d1fae5; color: #065f46; border: 1px solid #a7f3d0;' :
                          ($fundRequest->status == 'Draft' ? 'background-color: #f3f4f6; color: #374151; border: 1px solid #d1d5db;' : 'background-color: #fee2e2; color: #991b1b; border: 1px solid #fca5a5;'))) }}">
                        <div class="w-2 h-2 rounded-full mr-2"
                            style="{{ $fundRequest->status == 'Approved' ? 'background-color: #10b981;' :
                              ($fundRequest->status == 'Under Review' ? 'background-color: #f59e0b;' :
                              ($fundRequest->status == 'Submitted' ? 'background-color: #10b981;' :
                              ($fundRequest->status == 'Draft' ? 'background-color: #6b7280;' : 'background-color: #ef4444;'))) }}">
                        </div>
                        {{ $fundRequest->status }}
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-6">
                        <!-- Request ID Card -->
                        <div class="rounded-xl p-4 border shadow-sm hover:shadow-md transition-shadow duration-200" style="background: linear-gradient(135deg, rgba(255,255,255,0.8), rgba(243,244,246,0.8)); border-color: #d1d5db;">
                            <div class="flex items-center justify-between mb-3">
                                <h3 class="text-sm font-semibold uppercase tracking-wide" style="color: #1f2937;">Request ID</h3>
                                <i class="fas fa-hashtag" style="color: #6b7280;"></i>
                            </div>
                            <p class="text-2xl font-bold font-mono" style="color: #1f2937;">FR-{{ $fundRequest->id }}</p>
                            <p class="text-xs mt-1" style="color: #6b7280;">Unique identifier for tracking</p>
                        </div>

                        <!-- Date Requested Card -->
                        <div class="rounded-xl p-4 border shadow-sm hover:shadow-md transition-shadow duration-200" style="background: linear-gradient(135deg, #ecfdf5, #d1fae5); border-color: #a7f3d0;">
                            <div class="flex items-center justify-between mb-3">
                                <h3 class="text-sm font-semibold uppercase tracking-wide" style="color: #1f2937;">Date Requested</h3>
                                <i class="fas fa-calendar-alt" style="color: #10b981;"></i>
                            </div>
                            <p class="text-xl font-bold" style="color: #1f2937;">{{ $fundRequest->created_at->format('M d, Y') }}</p>
                            <p class="text-xs mt-1" style="color: #6b7280;">{{ $fundRequest->created_at->diffForHumans() }}</p>
                        </div>
                    </div>
                    ...
                    <div class="space-y-6">
                        <!-- Amount Card -->
                        <div class="rounded-xl p-6 border shadow-sm hover:shadow-md transition-shadow duration-200" style="background: linear-gradient(135deg, #ecfdf5, #d1fae5); border-color: #a7f3d0;">
                            <div class="flex items-center justify-between mb-3">
                                <h3 class="text-sm font-semibold uppercase tracking-wide" style="color: #1f2937;">Requested Amount</h3>
                                <i class="fas fa-peso-sign" style="color: #10b981;"></i>
                            </div>
                            <div x-show="!editMode">
                                <p class="text-3xl font-bold" style="color: #10b981;">₱{{ number_format($fundRequest->amount, 2) }}</p>
                            </div>
                            <div x-show="editMode" x-transition>
                                <input
                                    type="number"
                                    x-model="requestData.amount"
                                    class="w-full px-3 py-2 bg-white border rounded-lg transition-colors duration-200"
                                    style="border-color: #d1d5db; color: #1f2937;"
                        ...
                        <!-- Purpose Card -->
                        <div class="rounded-xl p-6 border shadow-sm hover:shadow-md transition-shadow duration-200" style="background: linear-gradient(135deg, #fef3c7, #fde68a); border-color: #fbbf24;">
                            <div class="flex items-center justify-between mb-3">
                                <h3 class="text-sm font-semibold uppercase tracking-wide" style="color: #1f2937;">Purpose</h3>
                                <i class="fas fa-bullseye" style="color: #f59e0b;"></i>
                            </div>
                            <div x-show="!editMode">
                                <p class="text-lg font-semibold" style="color: #1f2937;">{{ $fundRequest->purpose }}</p>
                            </div>
                            <div x-show="editMode" x-transition>
                                <input
                                    type="text"
                ...
                <!-- Details Section -->
                <div class="mt-8">
                    <div class="rounded-xl p-6 border shadow-sm hover:shadow-md transition-shadow duration-200" style="background: linear-gradient(135deg, rgba(243,244,246,0.8), rgba(229,231,235,0.8)); border-color: #d1d5db;">
                        <div class="flex items-center justify-between mb-4">
                            <h3 class="text-lg font-semibold flex items-center" style="color: #1f2937;">
                                <i class="fas fa-align-left mr-3" style="color: #6b7280;"></i>
                                Additional Details
                            </h3>
                        </div>
                        <div x-show="!editMode">
                            <p class="leading-relaxed" style="color: #1f2937;">
                        ...
                        <div x-show="editMode" x-transition>
                            <textarea
                                ...
                                rows="4"
                                class="w-full px-4 py-3 bg-white border rounded-lg resize-none transition-colors duration-200"
                                style="border-color: #d1d5db; color: #1f2937;"
                                onfocus="this.style.borderColor='#10b981'; this.style.boxShadow='0 0 0 2px rgba(16, 185, 129, 0.2)';"
                                onblur="this.style.borderColor='#d1d5db'; this.style.boxShadow='none';"
                ...
                <div x-show="editMode" x-transition class="mt-6 flex justify-end space-x-3">
                    <button
                        ...
                        class="px-6 py-2 border rounded-lg transition-all duration-200 shadow-sm"
                    ...
                    <button
                        class="px-6 py-2 text-white rounded-lg transition-all duration-200 shadow-md hover:shadow-lg transform hover:scale-105"
                        style="background-color: #10b981;"
                        onmouseover="this.style.backgroundColor='#059669'"
                        onmouseout="this.style.backgroundColor='#10b981'"
                    >
        ...
        <div x-data="{
                ...
                <div class="px-6 py-5">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center space-x-4">
                            ...
                            <div>
                                <h2 class="text-xl font-bold text-white">Supporting Documents</h2>
                        ...
                        <div class="flex items-center space-x-3">
                            @if($fundRequest->documents->isNotEmpty())
                            <div class="flex items-center rounded-lg border p-1" style="background-color: #f3f4f6; border-color: #10b981;">
                                <button
                                    @click="viewMode = 'grid'"
                                    class="p-2 rounded-md transition-all duration-200"
                                    :style="viewMode === 'grid' ? 'background-color: #10b981; color: white;' : 'color: #6b7280;'"
                                    title="Grid View"
                                >
                                ...
                                <button
                                    @click="viewMode = 'list'"
                                    class="p-2 rounded-md transition-all duration-200"
                                    :style="viewMode === 'list' ? 'background-color: #10b981; color: white;' : 'color: #6b7280;'"
                                    title="List View"
                                >
                            ...
                            <button
                                ...
                                class="inline-flex items-center px-4 py-2 rounded-lg text-sm font-medium text-white transition-all duration-200 shadow-sm"
                                style="background-color: #10b981; border: 1px solid #059669;"
                                :style="!showDocuments ? 'background-color: #059669; border-color: #047857;' : ''"
                                onmouseover="this.style.backgroundColor='#059669'; this.style.borderColor='#047857';"
                                onmouseout="!showDocuments ? '' : (this.style.backgroundColor='#10b981', this.style.borderColor='#059669')"
                            >
            ...
            <div x-show="uploadMode"
                 ...
                 x-transition:enter-end="opacity-100 transform translate-y-0"
                 class="border-b" style="border-color: #d1d5db; background-color: rgba(255,255,255,0.5);">
                <div class="p-6">
                    <div
                    ...
                    >
                        <div class="flex flex-col items-center">
                            <div class="w-16 h-16 bg-gradient-to-br from-green-600 to-red-800 rounded-full flex items-center justify-center mb-4">
                                ...
                                <div class="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-50 transition-all duration-300 flex items-center justify-center opacity-0 group-hover:opacity-100">
                                    <div class="flex space-x-2">
                                        <button
                                            ...
                                            class="p-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors duration-200"
                                            title="Quick Preview"
                                        >
                        ...
                        <div class="bg-gradient-to-r from-white to-gray-50 rounded-xl border border-gray-200 p-4 hover:shadow-md transition-all duration-300">
                            <div class="flex items-center justify-between">
                                ...
                                <div class="flex items-center space-x-2">
                                    <button
                                        @click="selectedDocument = {{ $index }}"
                                        class="p-2 text-white bg-green-600 hover:text-white hover:bg-green-700 rounded-lg transition-all duration-200"
                                    ...
                                    <a href="{{ asset('storage/' . $document->file_path) }}"
                                       target="_blank"
                                       class="inline-flex items-center px-3 py-2 bg-green-600 text-white rounded-lg text-sm hover:bg-green-700 transition-colors duration-200">
                ...
                @else
                    ...
                    <div class="text-center py-12">
                        ...
                        <button
                            ...
                            class="inline-flex items-center px-6 py-3 bg-green-600 text-white rounded-lg font-medium hover:bg-green-700 transition-colors duration-200 shadow-sm hover:shadow-md"
                        >
                            <i class="fas fa-upload mr-2"></i>
...
>
    <div class="flex items-center justify-center min-h-screen px-2 sm:px-4">
        ...
        >
            <!-- Modal Header -->
            <div class="bg-gradient-to-r from-green-600 to-red-800 px-3 sm:px-6 py-3 sm:py-5 sticky top-0 z-10">
                <div class="flex items-center justify-between">
                    <h3 class="text-base sm:text-xl font-bold text-white flex items-center">
                        <i class="fas fa-shield-alt mr-2 sm:mr-3 text-green-200 text-sm sm:text-base"></i>
                        <span class="hidden sm:inline">Data Privacy Policy for Fund Requests</span>
                        <span class="sm:hidden">Privacy Policy</span>
                    </h3>
                    <button
                        type="button"
                        class="text-white hover:text-green-200 focus:outline-none transition-colors duration-200"
                        @click="$store.openModal = null"
                    >
            ...
            <div class="bg-gray-100 px-3 sm:px-6 py-2 sm:py-3 border-b border-gray-200 overflow-x-auto whitespace-nowrap">
                <div class="flex space-x-1 sm:space-x-2">
                    <button
                        ...
                        :class="{'bg-green-600 text-white': activeTab === 'collection', 'bg-white text-gray-700 hover:bg-gray-50': activeTab !== 'collection'}"
                    ...
                    <button
                        ...
                        :class="{'bg-green-600 text-white': activeTab === 'usage', 'bg-white text-gray-700 hover:bg-gray-50': activeTab !== 'usage'}"
                        class="px-2 sm:px-4 py-1.5 sm:py-2 rounded-lg font-medium text-xs sm:text-sm transition-all duration-200 flex items-center shadow-sm flex-shrink-0"
                    >
                    ...
                    <button
                        ...
                        :class="{'bg-green-600 text-white': activeTab === 'security', 'bg-white text-gray-700 hover:bg-gray-50': activeTab !== 'security'}"
                        class="px-2 sm:px-4 py-1.5 sm:py-2 rounded-lg font-medium text-xs sm:text-sm transition-all duration-200 flex items-center shadow-sm flex-shrink-0"
                    >
                    ...
                    <button
                        ...
                        :class="{'bg-green-600 text-white': activeTab === 'retention', 'bg-white text-gray-700 hover:bg-gray-50': activeTab !== 'retention'}"
                        class="px-2 sm:px-4 py-1.5 sm:py-2 rounded-lg font-medium text-xs sm:text-sm transition-all duration-200 flex items-center shadow-sm flex-shrink-0"
                    >
                    ...
                    <button
                        ...
                        :class="{'bg-green-600 text-white': activeTab === 'rights', 'bg-white text-gray-700 hover:bg-gray-50': activeTab !== 'rights'}"
                        class="px-2 sm:px-4 py-1.5 sm:py-2 rounded-lg font-medium text-xs sm:text-sm transition-all duration-200 flex items-center shadow-sm flex-shrink-0"
                    >
                    ...
                    <button
                        ...
                        :class="{'bg-green-600 text-white': activeTab === 'contact', 'bg-white text-gray-700 hover:bg-gray-50': activeTab !== 'contact'}"
                        class="px-2 sm:px-4 py-1.5 sm:py-2 rounded-lg font-medium text-xs sm:text-sm transition-all duration-200 flex items-center shadow-sm flex-shrink-0"
                    >
            ...
            <div class="bg-gray-100 px-6 py-4 border-t border-gray-200 flex justify-between items-center">
                ...
                <button
                    type="button"
                    class="px-5 py-2.5 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-all duration-300 shadow-md hover:shadow-lg transform hover:-translate-y-0.5 flex items-center"
                    @click="$store.openModal = null"
                >
