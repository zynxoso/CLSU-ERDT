<div>
    ...
    <x-navigation />
        ...
        <div class="bg-gray-50 py-24 relative bg-cover bg-center bg-no-repeat" style="background-image: url('{{ asset('images/bgloginscholar.png') }}');">
            ...
            <div class="container mx-auto px-4 relative z-10">
                <div class="text-center max-w-4xl mx-auto">
                    <h1 class="text-4xl md:text-6xl font-bold text-white mb-4">
                        ...
                        <span class="block text-green-300">CLSU-ERDT Portal</span>
                    </h1>
                    <h2 class="text-xl md:text-2xl font-medium text-gray-100 mb-8">
                        ...
                        <div class="flex items-start justify-between mb-3">
                            ...
                            <div x-show="!expanded" x-cloak>
                                ...
                                @if(strlen($announcement->content) > 200)
                                            <button @click="expanded = true" class="text-green-600 hover:text-green-800 font-medium mt-2 inline-flex items-center">
                                                Read more
                            ...
                            <div x-show="expanded" x-collapse x-cloak>
                                        ...
                                        <button @click="expanded = false" class="text-green-600 hover:text-green-800 font-medium mt-2 inline-flex items-center">
                                            Show less
    ...
    <div class="py-16 bg-white">
        <div class="container mx-auto px-4">
            <div class="max-w-4xl mx-auto text-center mb-12">
                ...
                <div class="w-20 h-1 mx-auto mb-6 rounded bg-gradient-to-r from-green-500 to-green-500"></div>
            ...
            <div class="grid md:grid-cols-3 gap-6 max-w-6xl mx-auto">
                <a href="{{ route('how-to-apply') }}" class="group block bg-white rounded-lg shadow-md hover:shadow-lg p-6 transition-all duration-300 transform hover:-translate-y-1">
                    <div class="flex items-center mb-3">
                        ...
                        <div class="ml-4">
                            <h3 class="text-lg font-bold text-gray-800 group-hover:text-green-600 transition-colors duration-300">How to Apply</h3>
                    </div>
                    </div>
                ...
                <a href="{{ route('history') }}" class="group block bg-white rounded-lg shadow-md hover:shadow-lg p-6 transition-all duration-300 transform hover:-translate-y-1">
                    <div class="flex items-center mb-3">
                        ...
                        <div class="ml-4">
                            <h3 class="text-lg font-bold text-gray-800 group-hover:text-green-600 transition-colors duration-300">Our History</h3>
                    </div>
                    </div>
