<div class="min-h-screen"
    ...
    <div class="container mx-auto px-4">
        <div class="flex justify-between items-center mb-6">
            <div>
                <h1 class="text-2xl font-bold" style="color: rgb(23 23 23); font-size: 24px;">Manage Scholars</h1>
                <p class="mt-1" style="color: rgb(64 64 64); font-size: 15px;">Oversee and manage scholar profiles and status
                </p>
            </div>
        ...
        @if (session('success'))
            <div class="p-4 mb-4 relative rounded-lg border"
                style="background-color: rgba(76, 175, 80, 0.1); border-color: rgb(34 197 94); color: rgb(34 197 94);" role="alert">
                <p class="font-bold" style="font-size: 15px;">Success!</p>
                <p style="font-size: 15px;">{!! session('success') !!}</p>
                <button class="absolute top-0 right-0 mt-4 mr-4" style="color: rgb(34 197 94);"
        ...
        @if (session('error'))
            <div class="p-4 mb-4 relative rounded-lg border"
                style="background-color: rgb(255 235 238); border-color: rgb(211 47 47); color: rgb(183 28 28);" role="alert">
                <p class="font-bold" style="font-size: 15px;">Error!</p>
                <p style="font-size: 15px;">{{ session('error') }}</p>
                <button class="absolute top-0 right-0 mt-4 mr-4" style="color: rgb(183 28 28);"
                    onclick="this.parentElement.style.display='none'">
                    <i class="fas fa-times"></i>
                </button>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <div>
                    <label for="status" class="block text-sm font-medium mb-2"
                        style="color: rgb(64 64 64); font-size: 15px;">Status</label>
                ...
                <div>
                    <label for="start_date" class="block text-sm font-medium mb-2"
                        style="color: rgb(64 64 64); font-size: 15px;">Start Date</label>
                ...
                <div>
                    <label for="search" class="block text-sm font-medium mb-2"
                        style="color: rgb(64 64 64); font-size: 15px;">Search</label>
                    <div class="relative">
                        <input type="text" id="search" wire:model.live.debounce.300ms="search"
                            placeholder="Name, Email, or ID" class="w-full border rounded-md pl-10 pr-3 py-2"
                            style="background-color: rgb(255 255 255); border-color: rgb(224 224 224); color: rgb(64 64 64); font-size: 15px;">
                        <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                            <i class="fas fa-search" style="color: rgb(115 115 115);"></i>
                        </div>
                    </div>
                </div>
                <div class="flex items-end space-x-2">
                    ...
                    <button type="button" wire:click="resetFilters" class="px-4 py-2 border rounded-lg"
                        style="background-color: rgb(255 255 255); color: rgb(64 64 64); border-color: rgb(224 224 224); font-size: 15px;">
                        Reset
                    </button>
                </div>
            </div>
        ...
        <div wire:loading class="w-full">
            <div class="flex justify-center items-center py-8">
                <div class="h-10 w-10 border-4 rounded-full animate-spin" style="border-color: rgb(224 224 224); border-top-color: rgb(34 197 94);"></div>
            </div>
        </div>
                        ...
                        <thead style="background-color: rgb(248 249 250);">
                            <tr>
                                <th scope="col"
                                    ...
                                    style="color: rgb(115 115 115);">Scholar</th>
                                <th scope="col"
                                    class="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider"
                                    style="color: rgb(115 115 115);">Academic Level</th>
                                <th scope="col"
                                    class="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider"
                                    style="color: rgb(115 115 115);">Gender</th>
                                <th scope="col"
                                    class="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider"
                                    style="color: rgb(115 115 115);">Status</th>
                                <th scope="col"
                                    class="px-6 py-3 text-center text-xs font-medium uppercase tracking-wider"
                                    style="color: rgb(115 115 115);">Actions</th>
                            </tr>
                        </thead>
                        <tbody class="divide-y" style="background-color: rgb(255 255 255); border-color: rgb(224 224 224);">
                            @foreach ($scholars as $scholar)
                                <tr>
                                        ...
                                        <div class="flex items-center">
                                            ...
                                            <div class="ml-4">
                                                <div class="text-sm font-medium"
                                                    style="color: rgb(23 23 23); font-size: 15px;"
                                                    title="{{ $scholar->full_name }}">
                                                    {{ Str::limit($scholar->full_name, 25, '...') }}
                                                </div>
                                                <div class="text-sm" style="color: rgb(115 115 115); font-size: 14px;"
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm" style="color: rgb(23 23 23); font-size: 15px;">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span
                                            ...
                                            @if ($scholar->status == 'Active') " style="background-color: rgb(34 197 94); color: rgb(255 255 255);"
                                            @elseif($scholar->status == 'Graduated') " style="background-color: rgb(59 130 246); color: rgb(255 255 255);"
                                            @elseif($scholar->status == 'Deferred') " style="background-color: rgb(251 191 36); color: rgb(151 90 22);"
                                            @elseif($scholar->status == 'Dropped') " style="background-color: rgb(211 47 47); color: rgb(255 255 255);"
                                            @elseif($scholar->status == 'Inactive') " style="background-color: rgb(115 115 115); color: rgb(255 255 255);"
            ...
            @else
                <div class="text-center py-12">
                    <div class="w-16 h-16 mx-auto rounded-full flex items-center justify-center mb-4"
                        ...
                        <i class="fas fa-user-graduate text-2xl" style="color: rgb(115 115 115);"></i>
                    </div>
                    <h3 class="text-lg font-medium mb-2" style="color: rgb(23 23 23); font-size: 18px;">No Scholars Found
                    </h3>
                    <p class="mb-6" style="color: rgb(115 115 115); font-size: 15px;">There are no scholars matching your
                        filter criteria.</p>
