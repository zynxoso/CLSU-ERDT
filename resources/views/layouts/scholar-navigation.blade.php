        ...
        <div class="flex flex-col h-full">
            ...
            <nav class="flex-1 px-4 py-4 space-y-1">
                ...
                <a href="{{ route('scholar.settings') }}"
                   class="flex items-center px-4 py-3 text-sm font-medium rounded-lg {{ request()->routeIs('scholar.settings') || request()->routeIs('scholar.password*') ? 'bg-blue-50 text-blue-700' : 'text-gray-700 hover:bg-gray-50' }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
