...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Edit Timeline Item</h1>
            <p class="text-gray-600">Update application timeline item for the public website</p>
        </div>
    ...
    <div class="bg-white shadow-sm rounded-lg">
        ...
        <form action="{{ route('super_admin.application_timeline.update', $timeline->id) }}" method="POST" class="p-6 space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 gap-6">
                ...
                <div>
                    ...
                    <input type="text"
                           id="activity"
                           name="activity"
                           value="{{ old('activity', $timeline->activity) }}"
                ...
                <div>
                    ...
                    <input type="text"
                           id="first_semester"
                           name="first_semester"
                           value="{{ old('first_semester', $timeline->first_semester) }}"
                ...
                <div>
                    ...
                    <input type="text"
                           ...
                           value="{{ old('second_semester', $timeline->second_semester) }}"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select id="is_active"
                            ...
                            <option value="1" {{ old('is_active', $timeline->is_active) == 1 ? 'selected' : '' }}>Active</option>
                            <option value="0" {{ old('is_active', $timeline->is_active) == 0 ? 'selected' : '' }}>Inactive</option>
                        </select>
                        @error('is_active')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
            ...
            <div class="flex items-center justify-end space-x-4 pt-6 border-t border-gray-200">
                ...
                <button type="submit"
                    ...
                    <i class="fas fa-save mr-2"></i>Update Timeline Item
                </button>
            </div>
        </form>
    </div>
