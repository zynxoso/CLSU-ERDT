    ...
    <div class="rounded-xl shadow-xl w-full max-w-md mx-4" style="background-color: #FAFAFA;">
        <div class="p-6">
            <div class="flex items-center justify-between mb-4">
                <h3 class="text-lg font-semibold" style="color: rgb(23 23 23);">Reject Fund Request</h3>
                <button onclick="document.getElementById('reject-modal').classList.add('hidden')" class="transition-colors duration-150" style="color: rgb(115 115 115);" onmouseover="this.style.color='#D32F2F'" onmouseout="this.style.color='#757575'">
            ...
            <form action="{{ route('admin.fund-requests.reject', $fundRequest->id) }}" method="POST">
                ...
                <div class="mb-4">
                    <label for="reject-notes" class="block text-sm font-medium mb-1" style="color: rgb(64 64 64);">Reason for Rejection <span style="color: #D32F2F;">*</span></label>
                    <textarea id="reject-notes" name="rejection_reason" rows="3" class="w-full px-3 py-2 rounded-md shadow-sm focus:outline-none transition-colors duration-200" style="border: 1px solid #E0E0E0; background-color: rgb(255 255 255); color: rgb(64 64 64);" placeholder="Please provide the reason for rejection..." required onfocus="this.style.borderColor='#D32F2F'" onblur="this.style.borderColor='#E0E0E0'">{{ old('rejection_reason') }}</textarea>
                ...
                <div class="flex justify-end space-x-3">
                    <button type="button" onclick="document.getElementById('reject-modal').classList.add('hidden')" class="px-4 py-2 rounded-md text-sm font-medium transition-colors duration-200" style="color: rgb(255 255 255); background-color: rgb(115 115 115); border: 1px solid #757575;" onmouseover="this.style.backgroundColor='#616161'" onmouseout="this.style.backgroundColor='#757575'">
                        Cancel
                    </button>
