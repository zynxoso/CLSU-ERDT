...
{{--                            <span class="text-gray-500 text-base">₱</span>--}}
                    ...
                    <div class="mb-6">
                        ...
                        <textarea id="purpose" name="purpose" rows="4" class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Please provide a detailed description of the purpose for this fund request..." required>{{ old('purpose') }}</textarea>
                        @error('purpose')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                        ...
                        <div class="flex items-center justify-center w-full">
                            <label for="dropzone-file" class="flex flex-col items-center justify-center w-full min-h-[8rem] sm:min-h-[12rem] md:min-h-[16rem] border-2 border-blue-300 border-dashed rounded-lg cursor-pointer bg-blue-50 hover:bg-blue-100 transition-colors duration-200 px-2 sm:px-6">
                                <div class="flex flex-col items-center justify-center pt-4 sm:pt-5 pb-4 sm:pb-6 w-full">
                                    ...
                                    <p class="text-xs sm:text-sm text-blue-400 text-center">PDF only (Max. 10MB)</p>
                                </div>
                        ...
                        <div class="flex items-start">
                            ...
                            <div class="flex-1">
                                <label for="privacy-agreement-checkbox" class="text-sm text-gray-700">
                                    I agree to the <button type="button" id="open-privacy-modal" class="text-blue-600 hover:text-blue-800 underline">Data Privacy Agreement</button> for document uploads.
                                </label>
                ...
                <div id="step-3" class="step-content hidden">
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg mb-6">
                        <h3 class="font-semibold text-gray-800 mb-3">Review Your Request</h3>
                        <div class="space-y-2">
                            <div class="flex justify-between">
                                <span class="text-gray-600">Request Type:</span>
                                <span id="review-request-type" class="font-medium">-</span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-gray-600">Amount:</span>
                                <span id="review-amount" class="font-medium">-</span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-gray-600">Purpose:</span>
                                <span id="review-purpose" class="font-medium">-</span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-gray-600">Document:</span>
                                <span id="review-document" class="font-medium">-</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex justify-between">
                        ...
                        <div class="space-x-4">
                            <button type="submit" name="status" value="Draft" class="px-6 py-2 bg-gray-500 text-white rounded-lg hover:bg-gray-600 transition-colors duration-300">
                                <i class="fas fa-save mr-2"></i> Save as Draft
                            </button>
                            <button type="submit" name="status" value="Submitted" class="px-6 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-colors duration-300">
