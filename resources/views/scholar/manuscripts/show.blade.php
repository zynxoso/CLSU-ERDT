                ...
                <div class="flex space-x-2">
                    @if(in_array($manuscript->status, ['Draft', 'Revision Requested']))
                        ...
                        <form action="{{ route('scholar.manuscripts.submit', $manuscript->id) }}" method="POST" class="inline">
                            @csrf
                            @method('PUT')
                            <button type="submit" class="px-3 py-1 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-all duration-200 hover:shadow-md transform hover:scale-105 cursor-pointer" onclick="return confirm('Are you sure you want to submit this manuscript for review?')">
                    ...
                    <div class="text-gray-700 leading-relaxed">
                        @if(strlen($manuscript->abstract) > 400)
                            <div id="abstract-preview">
                                ...
                                <button class="inline-flex items-center text-blue-600 hover:text-blue-800 text-sm mt-2 font-medium transition-colors duration-200 cursor-pointer show-more" data-target="abstract-full">
                            ...
                            <div id="abstract-full" class="hidden">
                                {{ $manuscript->abstract }}
                                <button class="inline-flex items-center text-blue-600 hover:text-blue-800 text-sm mt-2 font-medium transition-colors duration-200 cursor-pointer show-less" data-target="abstract-preview">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div class="flex justify-between items-start">
                        ...
                        <span class="px-3 py-1 text-xs font-medium rounded-full
                            ...
                            @elseif($manuscript->status == 'Submitted') bg-blue-100 text-blue-800 border border-blue-200
                    ...
                    <div class="text-amber-700">
                        @if(strlen($manuscript->admin_notes) > 250)
                            <div id="notes-preview">
                                ...
                                <button class="inline-flex items-center text-blue-600 hover:text-blue-800 text-sm mt-2 font-medium transition-colors duration-200 cursor-pointer show-more" data-target="notes-full">
                                    <i class="fas fa-expand-alt mr-1 text-xs"></i>
                                    Show more
                                </button>
                            </div>
                            <div id="notes-full" class="hidden">
                                ...
                                <button class="inline-flex items-center text-blue-600 hover:text-blue-800 text-sm mt-2 font-medium transition-colors duration-200 cursor-pointer show-less" data-target="notes-preview">
                                    <i class="fas fa-compress-alt mr-1 text-xs"></i>
                                    Show less
                                </button>
                            </div>
